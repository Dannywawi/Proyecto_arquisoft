...
while True:
    ...
    try:
        ...
        while True:
            ...
            filtro2 = {"nombre":data["sucursal"]}
            maxMesas = collectionSucursales.find_one(filtro2,{"mesas":1,"_id":0})
            ...
            if int(result) + int(data["mesas"]) <= maxMes and horarios!=None: 
                ...
                msg = "sobrepaso la cantidad de mesas maximas disponibles"
                connection.sendall(pickle.dumps(msg))
                break
